 ...
 *************************************************************/
 ...
 private $oConexion=null; 
		...
		$bRet = false;
			try{
				$this->oConexion = new mysqli("localhost:3306", "root", "", "covid19"); 
				//$this->oConexion = new PDO("mysql:host=localhost;dbname=covid19","root","",  array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES 'UTF8'")); 
				$bRet = true;
			}catch(Exception $e){
				throw $e;
			}
